...
#include "YWidget_ItemComponentUpgradePrice.generated.h"

class UYWidget_ItemContainer;

UCLASS(Blueprintable, EditInlineNew)
class UYWidget_ItemComponentUpgradePrice : public UYWidget_ItemComponentBase {
    GENERATED_BODY()
public:
protected:
...
public:
    UYWidget_ItemComponentUpgradePrice();
