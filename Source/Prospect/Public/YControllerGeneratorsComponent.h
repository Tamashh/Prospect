...
#include "YControllerGeneratorsComponent.generated.h"

UCLASS(Blueprintable, ClassGroup=Custom, meta=(BlueprintSpawnableComponent))
class PROSPECT_API UYControllerGeneratorsComponent : public UActorComponent {
    GENERATED_BODY()
public:
    ...
    UYControllerGeneratorsComponent(const FObjectInitializer& ObjectInitializer);
