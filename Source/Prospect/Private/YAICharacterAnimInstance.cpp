...
UYAICharacterAnimInstance::UYAICharacterAnimInstance() {
    ...
    this->m_maxLookAtDistance = 600.0f;
    this->m_lookAtEnabled = false;
    this->m_lookAtBlocked = false;
}

EYFourWayDirection UYAICharacterAnimInstance::DetermineDamageDirection(FYDealtDamageData damageData) {
    return EYFourWayDirection::Front;
}
